...
describe('WiroClient discovery wire contract', () => {
  it('matches the Tool/List response contract', async () => {
  ...
  it('matches Tool/Explore contract and parses categories', async () => {
    const transport = new FakeHttpTransport();
  ...
  it('matches Tool/Detail contract and parses schema', async () => {
    const transport = new FakeHttpTransport();
    transport.enqueueJson(
      200,
      JSON.stringify({
